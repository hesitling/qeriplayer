...
- Update `ServiceLocator` and `NeriPlayerApplication` to register and initialize all new core services.
...
- Modified files: `src/app/ServiceLocator.h`, `src/app/NeriPlayerApplication.h/.cpp`.
